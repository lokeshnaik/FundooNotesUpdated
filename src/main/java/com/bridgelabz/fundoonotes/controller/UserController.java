...
public class UserController 
{
	...
	public ResponseEntity<UserResponse> forgotPassword(@RequestParam("email") String email) throws UserException 
	{
		boolean result = services.forgotPassword(email);
		return ResponseEntity.status(HttpStatus.ACCEPTED).body(new UserResponse("User Exists", 200,result));
	}
